...
\end{equation}
The above ODE can be solved by noting that it is Hamiltonian with \(H(q,p) = \frac 1 2 p^2 + \frac v 2 q^2 - \frac 12 q^4\) and the non-zero equilibria of the system occur when \((\varphi, \varphi') = (\pm \frac v {\sqrt 2}, 0)\). Then finding the solutions along the level set \(H(\pm \frac c {\sqrt 2}, 0) = \frac {c^2} 8\) gives 
\begin{equation}
