...
\section{Counter-propagating ansatz}

%Write out counter-propagting ansatz for solution 

%Write out the PDEs for f, g, phi
%% explain that we want f to have non-zero limits at plus or minus infinity

%Introduce unweighted Banach spaces and give lemmas for products (put proofs in appendix)
%% explain that we require localization of f and g so that phi remains bounded for all time
%% introduce weighted Banach spaces (perhaps add proof that \mcX^k_m is actually a Banach space)
%% right/left limit spaces lead to general space
...
%Write the resulting equations for 
